...
async function fetchRules() {
  ...
  ruleStore.updateIsReorderActive(false)
  await Promise.allSettled([ruleStore.fetchRules({ groupTypeEnumId: 'RG_THRESHOLD', pageSize: 50 }), productStore.fetchConfigFacilities(), productStore.fetchFacilityGroups()]);
